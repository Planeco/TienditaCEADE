...
<body> 
	<div id="container" class="clearfix">
		...
		<aside id="sidebar-main" class="sidebar">
        	...
        	<?php include_once('navsoporte.php'); ?>
            ...
            <div id="content" class="clearfix">
                ...
                <header id="header-sec"> 
                	<div class="inner-padding"> 
                        <div class="pull-left">
                            <h2><i class="fa fa-user"></i> &nbsp;Soporte</h2>
                        </div>
                    </div>
            	</header>
                            	...
                            	<div class="col-sm-12">
                                    <div class="inner-padding">
                                		...
                                		<div class="alert alert-block alert-dismissable alert-danger">
                                			<h4>Para solicitudes de soporte</h4>
    	                            		<p>Refiérase al sistema OMS de Reinventando a México en: <a href="http://oms.reinventandoamexico.com.mx" target="_new">http://oms.reinventandoamexico.com.mx</a></p>
	                                	</div>
